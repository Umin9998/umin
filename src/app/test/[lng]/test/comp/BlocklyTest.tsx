...
import { useSequentialScriptLoader } from "./useScript"; // Adjust the path as needed
...
const scripts = [
  `/lib/${blocklyVersion}/blockly_compressed.js`,
  `/lib/${blocklyVersion}/blocks_compressed.js`,
  `/lib/${blocklyVersion}/javascript_compressed.js`,
  `/lib/${blocklyVersion}/python_compressed.js`,
  `/lib/${blocklyVersion}/msg/en.js`,
  `/lib/${blocklyVersion}/plugin/continuous-toolbox/index.js`, // from npm install @blockly/continuous-toolbox --save -> node_modules/@blockly/continuous-toolbox
];
...
const BlocklyTest = ({ blocklyDivRef, workspaceRef, setTest }: any) => {
    ...
    if (status === "ready" && toolboxXML && typeof Blockly !== "undefined") {
      ...
      const updateWorkspaceCode = () => {
        if (Blockly.JavaScript) {
          ...
          setTest(code);
          //document.getElementById('textarea').value = code; // For demonstration, log the generated code to the console
          // For demonstration, log the generated code to the console
