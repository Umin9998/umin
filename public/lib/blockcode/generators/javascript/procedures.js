...
Blockly.JavaScript['procedures_callreturn'] = function(block) {
  ...
  //var code = funcName + '(' + args.join(', ') + ')'; // ORG
  var code = 'await ' + funcName + '(' + args.join(', ') + ')';  // await added // CASS_BLOCKLY_MODIFIED
...
Blockly.JavaScript['procedures_return_with_value'] = function (block) {
