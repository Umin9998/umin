...
Blockly.JavaScript['controls_if'] = function(block) {
  ...
  //return code + '\n';
    ...
    // CASS
    if (block.getInput('DO_ELSE') || Blockly.JavaScript.STATEMENT_SUFFIX) { // CASS_BLOCKLY_MODIFIED // ADDED
        branchCode = Blockly.JavaScript.statementToCode(block, 'DO_ELSE'); // CASS_BLOCKLY_MODIFIED // ADDED
        if (Blockly.JavaScript.STATEMENT_SUFFIX) {
            branchCode = Blockly.JavaScript.prefixLines(
                Blockly.JavaScript.injectId(Blockly.JavaScript.STATEMENT_SUFFIX,
                    block), Blockly.JavaScript.INDENT) + branchCode;
...
Blockly.JavaScript['controls_if_ext'] = Blockly.JavaScript['controls_if']; // CASS_PXT_ADDED
...
Blockly.JavaScript['variables_value_undefined'] = function (block) {
    // undefined data type.
...
Blockly.JavaScript['logic_ternary'] = function (block) {
    ...
    var value_then = Blockly.JavaScript.valueToCode(block, 'THEN',
        Blockly.JavaScript.ORDER_CONDITIONAL) || 'null';
    //var value_else = Blockly.JavaScript.valueToCode(block, 'ELSE', // CASS_BLOCKLY_MODIFIED // COMMENTED
    var value_else = Blockly.JavaScript.valueToCode(block, 'DO_ELSE', // CASS_BLOCKLY_MODIFIED // ADDED
        Blockly.JavaScript.ORDER_CONDITIONAL) || 'null';
    var code = value_if + ' ? ' + value_then + ' : ' + value_else;
    return [code, Blockly.JavaScript.ORDER_CONDITIONAL];
};