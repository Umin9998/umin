...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  ...
  // Block for local variable setter.
  {
    ...
    "message0": "%{BKY_VARIABLES_SET_LOCAL}",
    "args0": [
      {
        "type": "field_variable",
        "name": "VAR",
    ...
    "nextStatement": null,
    "style": "variable_blocks",
    "tooltip": "%{BKY_VARIABLES_SET_LOCAL_TOOLTIP}",
    "helpUrl": "%{BKY_VARIABLES_SET_LOCAL_HELPURL}",
    "extensions": ["contextMenu_variableSetterGetter"]
  },
  // ADDED // CASS_BLOCKLY_MODIFIED
  // Block for undefined value.
  {
    "type": "variables_value_undefined",
    "message0": "%{BKY_VARIABLES_VALUE_UNDEFINED}",
    //"inputsInline": true,
    "output": null,
    "style": "variable_blocks",
    "tooltip": "%{BKY_VARIABLES_VALUE_UNDEFINED_TOOLTIP}",
    "helpUrl": "%{BKY_VARIABLES_VALUE_UNDEFINED_HELPURL}",
    //"extensions": ["contextMenu_variableSetterGetter"]
  },
  // Block for null data type. // CASS_MODIFIED // from logic.js
  {
    "type": "logic_null",
