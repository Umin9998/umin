...
// CASS // ADDED
if (Blockly.Msg["PROCEDURES_RETURN"] == undefined) Blockly.Msg["PROCEDURES_RETURN"] = "return";
if (Blockly.Msg["PROCEDURES_RETURN_WITH_VALUE"] == undefined) Blockly.Msg["PROCEDURES_RETURN_WITH_VALUE"] = "return with value";
...
Blockly.Blocks['procedures_defnoreturn'] = {
  ...
  init: function() {
    ...
    var nameField = new Blockly.FieldTextInput(initName,
        Blockly.Procedures.rename); // CASS_BREAK
    nameField.setSpellcheck(false);
    this.appendDummyInput()
        .appendField(Blockly.Msg['PROCEDURES_DEFNORETURN_TITLE'])
        .appendField(" ", null, 0, 0, 1) // CASS_ADDED
        .appendField(nameField, 'NAME')
        .appendField('', 'PARAMS');
    this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
    // COMMENTED // CASS_BLOCKLY_MODIFIED
...
Blockly.Blocks['procedures_defreturn'] = {
  ...
  init: function() {
    ...
    this.setMutator(new Blockly.Mutator(['procedures_mutatorarg']));
    // COMMENTED // CASS_BLOCKLY_MODIFIED // UNCOMMENTED
    if ((this.workspace.options.comments ||
         (this.workspace.options.parentWorkspace &&
          this.workspace.options.parentWorkspace.options.comments)) &&
...
Blockly.Blocks['procedures_callnoreturn'] = {
   ...
   * @this {Blockly.Block}
   */
  onchange: function(event) { // CASS_REF // last generated function block has changes
...
Blockly.Blocks['procedures_return_with_value'] = {
  /**
   * Block for conditionally returning a value from a procedure.
   * @this {Blockly.Block}
   */
  init: function() {
    this.appendValueInput('VALUE')
        .appendField(Blockly.Msg['PROCEDURES_RETURN_WITH_VALUE']);
    this.setInputsInline(false);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setStyle('procedure_blocks');
    this.setTooltip(Blockly.Msg['PROCEDURES_RETURN_WITH_VALUE_TOOLTIP']);
    this.setHelpUrl(Blockly.Msg['PROCEDURES_RETURN_WITH_VALUE_HELPURL']);
    this.hasReturnValue_ = true;
  },
  /**
   * Called whenever anything on the workspace changes.
  ...
  onchange: function(_e) {
    ...
    if (legal) {
      ...
      this.setWarningText(Blockly.Msg['PROCEDURES_RETURN_WARNING']);
      if (!this.isInFlyout && !this.getInheritedDisabled()) {
        this.setEnabled(false);
      }
    }
...
Blockly.Blocks['procedures_return'] = {
  ...
  init: function() {
    this.appendDummyInput('VALUE')
        .appendField(Blockly.Msg['PROCEDURES_RETURN']);
    this.setInputsInline(false);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setStyle('procedure_blocks');
    this.setTooltip(Blockly.Msg['PROCEDURES_RETURN_TOOLTIP']);
    this.setHelpUrl(Blockly.Msg['PROCEDURES_RETURN_HELPURL']);
    this.hasReturnValue_ = false;
  },
  /**
   * Called whenever anything on the workspace changes.
   ...
   * Blockly.Blocks['procedures_ifreturn'].FUNCTION_TYPES.push('custom_func');
   */
  FUNCTION_TYPES: ['procedures_defnoreturn']
};
