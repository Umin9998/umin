...
Blockly.Workspace = function(opt_options) {
  ...
  this.blockDB_ = Object.create(null);
    ...
    this.blockDBCollapsed_ = Object.create(null); // CASS_ADDED
...
Blockly.Workspace.prototype.copiedToPaste = false; // ADDED // CASS_BLOCKLY_MODIFIED
...
Blockly.Workspace.prototype.undo = function (redo) {
    ...
    // CASS
    const elem = document.getElementById("acs_module_three_ui_canvas");
    //if (elem == document.activeElement) {
    //    console.error('Element has focus!');
    //} else {
    //    console.error(`Element is not focused.`);
    //}
...
Blockly.Workspace.prototype.pasteCopied = function () {
    if (Blockly.clipboardXml_ !== undefined && Blockly.clipboardXml_ !== null && Blockly.clipboardXml_ !== '') {
        if (typeof acs_workspace_current !== 'undefined' && acs_workspace_current !== null) {
            acs_workspace_current.paste(Blockly.clipboardXml_);

            //Blockly.clipboardXml_ = Blockly.clipboardXmlBackup_;
            //Blockly.clipboardSource_ = Blockly.clipboardSourceBackup_;
        }
    }
};
...
Blockly.Workspace.prototype.fireChangeListener = function (event) {
    ...
    // CASS_MODIFIED // ADDED // COMMENTED: it makes do, undo weird
    //if (event.xml !== undefined && event.xml.outerHTML.search("procedures_callnoreturn")) {
    //    //var a = 1;
    //    return;
    //}
    //if (event.xml !== undefined && event.xml.outerHTML.search("procedures_callreturn")) {
    //    //var a = 1;
    //    return;
    //}
    // element: "dragStop"
