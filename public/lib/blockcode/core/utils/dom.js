...
Blockly.utils.dom.addStyle = function (element, key, value) {
...
Blockly.utils.dom.getTextWidth = function (textElement) {
  ...
  if (textElement == undefined || textElement == null) return 15; // CASS_ADDED // CASS_BLOCKLY_MODIFIED
...
Blockly.utils.dom.getFastTextWidth = function(textElement,
  ...
  if (textElement == undefined || textElement == null) return 15; // ADDED // CASS_BLOCKLY_MODIFIED
