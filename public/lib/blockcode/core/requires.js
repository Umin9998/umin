...
// goog.require('Blockly.WorkspaceCommentSvg'); // ORG // it was commented originally
// goog.require('Blockly.WorkspaceCommentSvg.render'); // ORG // it was commented originally

goog.require('Blockly.WorkspaceCommentSvg'); // CASS_PXT
goog.require('Blockly.WorkspaceCommentSvg.render'); // CASS_PXT
