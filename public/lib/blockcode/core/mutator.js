...
Blockly.Mutator.prototype.drawIcon_ = function(group) {
  ...
  //    group);
    ...
    Blockly.utils.dom.createSvgElement(
        ...
        {
            'class': 'blocklyIconShape',
            'x': '2.1', // coordinate // https://developer.mozilla.org/en-US/docs/Web/SVG/Element/rect
            'y': '1.1',
            'rx': '2', //'4', // CASS
            'ry': '2', //'4', // CASS
            'height': '11', //'16', // CASS
  ...
  Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.PATH,
      {
        ...
        // CASS // ADDED
        //'d': 'M341.333,0H42.667C19.093,0,0,19.093,0,42.667v298.667C0,364.907,19.093,384,42.667,384h298.667    C364.907,384,384,364.907,384,341.333V42.667C384,19.093,364.907,0,341.333,0z M298.667,213.333h-85.333v85.333h-42.667v-85.333    H85.333v-42.667h85.333V85.333h42.667v85.333h85.333V213.333z'
        //'d': 'm 13.653 0 h -11.947 c -0.943 0 -1.707 0.764 -1.707 1.707 v 11.947 c 0 0.943 0.764 1.707 1.707 1.707 h 11.947 c 0.943 0 1.707 -0.764 1.707 -1.707 v -11.947 c 0 -0.943 -0.764 -1.707 -1.707 -1.707 z m -1.707 8.533 h -3.413 v 3.413 h -1.707 v -3.413 h -3.413 v -1.707 h 3.413 v -3.413 h 1.707 v 3.413 h 3.413 v 1.707 z'
        /* -1 */ 'd': 'm 13.653 -1 h -11.947 c -0.943 0 -1.707 0.764 -1.707 1.707 v 11.947 c 0 0.943 0.764 1.707 1.707 1.707 h 11.947 c 0.943 0 1.707 -0.764 1.707 -1.707 v -11.947 c 0 -0.943 -0.764 -1.707 -1.707 -1.707 z m -1.707 8.533 h -3.413 v 3.413 h -1.707 v -3.413 h -3.413 v -1.707 h 3.413 v -3.413 h 1.707 v 3.413 h 3.413 v 1.707 z'
      },
      group);
...
Blockly.Mutator.prototype.createEditor_ = function() {
  ...
  */
  this.svgDialog_ = Blockly.utils.dom.createSvgElement(
      ...
      {'x': Blockly.Bubble.BORDER_WIDTH_MUTATOR, 'y': Blockly.Bubble.BORDER_WIDTH_MUTATOR}, // CASS
      //{'x': this.bubble_.BORDER_WIDTH_BUBBLE, 'y': this.bubble_.BORDER_WIDTH_BUBBLE}, // CASS
      null);
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
  ...
  //var height = workspaceSize.height + doubleBorderWidth * 3;
    ...
    var doubleBorderWidth = 2 * Blockly.Bubble.BORDER_WIDTH_MUTATOR; // CASS
    //var doubleBorderWidth = 2 * this.bubble_.BORDER_WIDTH_BUBBLE; // CASS
    var workspaceSize = this.workspace_.getCanvas().getBBox();
    var width = workspaceSize.width + workspaceSize.x - 40; // CASS
    var height = workspaceSize.height + doubleBorderWidth * 3 - 22; // CASS
