...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.blocklyIconShape {',
    //'fill: #00f;', // ORG
    'fill: #2b3f43;', // 'fill: #00f;', // CASS_BLOCKLY_MODIFIED
    'stroke: #fff;',
    'stroke-width: 1px;',
    'opacity: 0;', // CASS_ADDED
  '}',
  ...
  '.blocklyDropdownMenu .blocklyMenuItem {',
    ...
    'padding-left: 28px;',
    'color: #fff;', // CASS_ADDED
  '}',

  // CASS_ADDED
  '.blocklyDropdownMenu .blocklyMenuItem .blocklyMenuItemCheckbox {',
    'color: #fff;',
  '}',
  ...
  '.blocklyMenuItem {',
    'border: none;',
    //'color: #000;', // ORG // COMMENTED
    //'color: #fff;', // CASS // COMMENTED
    'cursor: pointer;',
    'list-style: none;',
    'margin: 0;',
  ...
  // CASS // ADDED // COMMENTED
  //'blocklyContextMenu .blocklyMenuItemContent {',
  //  'color: #333;',
  //'}',
  ...
  '.blocklyMenuItemSelected .blocklyMenuItemCheckbox {',
    //'background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px;', // ORG
    'background: url(<<<PATH>>>/sprites.png) no-repeat -62px -16px;', // CASS
    'float: left;',
    'margin-left: -24px;',
