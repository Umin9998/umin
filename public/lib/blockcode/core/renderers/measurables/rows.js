...
Blockly.blockRendering.InputRow.prototype.measure = function() {
  ...
  var _isAfterEmptyField = false; // CASS_ADDED
  //var _min_width = 0; // CASS_ADDED

  for (var e = 0, elem; (elem = this.elements[e]); e++) {


      // CASS_ADDED // CASS_2021! // This is it!
      ///////////////////////////////////////////////////////////////////////////////
      if (elem instanceof Blockly.blockRendering.Field) {

          if (elem.width == 0) {
              _isAfterEmptyField = true;
          }

          if (elem.field.min_width != null) {
              _isAfterEmptyField = true;
              elem.width = elem.field.min_width;
          }
      }
      else {

          if (_isAfterEmptyField) {
              if (elem instanceof Blockly.blockRendering.InRowSpacer) {

                  elem.width = 0;
                  //elem.width = _min_width;
              }
          }

          _isAfterEmptyField = false;
          //_min_width = 0;
      }
      ///////////////////////////////////////////////////////////////////////////////
