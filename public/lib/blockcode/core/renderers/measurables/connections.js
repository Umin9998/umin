...
Blockly.blockRendering.OutputConnection = function(constants, connectionModel) {
  ...
  this.connectionOffsetY = this.constants_.TAB_OFFSET_FROM_TOP; // ORG
  this.connectionOffsetX = 0; // ORG

    // CASS_ADDED
    var _sourceBlock = connectionModel.sourceBlock_;
    var _blockHeight = _sourceBlock.height;

    // CASS_ADDED // COMMENTED
    //if (_blockHeight === undefined || _blockHeight === 0) {
    //    this.connectionOffsetY = this.constants_.TAB_OFFSET_FROM_TOP; // CASS_2021! // CASS_PUZZLE_TAB
    //}
    //else {
    //    this.connectionOffsetY = _blockHeight / 2 - this.height / 2; // CASS_2021! // CASS_PUZZLE_TAB
    //}
};
