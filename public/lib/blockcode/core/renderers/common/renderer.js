 ...
 * @protected
 */
Blockly.blockRendering.Renderer.prototype.makeDrawer_ = function(block, info) { // <- Blockly.blockRendering.Renderer.prototype.render
  return new Blockly.blockRendering.Drawer(block, info); // CASS_2021 // CHECK
};
...
Blockly.blockRendering.Renderer.prototype.render = function(block) {
  ...
  var info = this.makeRenderInfo_(block);  // CASS_2021! // CHECK
  info.measure();  // CASS_2021 // CHECK // -> core/renderers/common/info.js -> computeBounds_ for width
