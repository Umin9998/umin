 ...
 * @return {string} An entity name that is legal in the exported language.
 */
Blockly.Names.prototype.getDistinctName = function(name, type) { // CASS_2021 // CHECK // VAR
 ...
 * @private
 */
Blockly.Names.prototype.safeName_ = function(name) { // CASS_2021 // CHECK // VAR // korean // unicode // ÇÑ±Û
  if (!name) {
