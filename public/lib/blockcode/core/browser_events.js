 ...
 * @public
 */
Blockly.browserEvents.conditionalBind = function ( // == Blockly.bindEventWithChecks_ // CASS_CHECK
  ...
  if (Blockly.utils.global['PointerEvent'] &&
    ...
    node.addEventListener(name, wrapFunc, false); // CASS_CHECK // node = this.svgGroup_ // name = 'wheel' // <- Blockly.bindEventWithChecks_(this.svgGroup_, 'wheel', this, this.wheel_)); in flyout_base.js
