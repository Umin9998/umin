 ...
 * @private
 */
//Blockly.WorkspaceCommentSvg.RESIZE_SIZE = 8; // ORG
Blockly.WorkspaceCommentSvg.RESIZE_SIZE = 12 * Blockly.WorkspaceCommentSvg.BORDER_WIDTH; // CASS_PXT
 ...
 * @private
 */
//Blockly.WorkspaceCommentSvg.TEXTAREA_OFFSET = 2; // ORG
Blockly.WorkspaceCommentSvg.TEXTAREA_OFFSET = 12; // 2; // CASS_PXT
...
Blockly.WorkspaceCommentSvg.prototype.addResizeDom_ = function() {
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      {'points': '0,0 0,x x,x x,0'.replace(/x/g, resizeSize.toString())}, // CASS_PXT
      this.resizeGroup_);
  Blockly.utils.dom.createSvgElement(
