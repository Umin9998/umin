...
Blockly.Field.prototype.CLICKABLE = true; // CASS_ADDED
...
Blockly.Field.prototype.init = function() {
  ...
  this.fieldGroup_ = Blockly.utils.dom.createSvgElement( // CASS_2021! // CHECK
  ...
  this.bindEvents_();
  this.initModel();
}; // CASS // -> Blockly.Input.prototype.init in input.js -> Blockly.BlockSvg.prototype.initSvg in block_svg.js that is called by createMarkerBlock_ in insertion_marker_manager.js // - wrong traking!! X

// CASS
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// inputList > filedRow > fieldGroup_ > outerHTML > transform // transform is set after invoking this.makeDrawer_ in .render in renderer.js

// Blockly.BlockSvg.prototype.render in block_svg.js is called in Blockly.Xml.domToBlock in xml.js when it's shown in flyout
// When Blockly.BlockSvg.prototype.initSvg is called in Blockly.Xml.domToBlock, the transform is not set yet.
// After Blockly.BlockSvg.prototype.render is called, the transform gets set.
// Blockly.BlockSvg.prototype.render in block_svg.js -> this.workspace.getRenderer().render(this); -> Blockly.blockRendering.Renderer.prototype.render in renderer.js
// -> this.makeDrawer_(block, info).draw();
// -> this.makeDrawer_ -> Blockly.blockRendering.Drawer in drawer.js -> Blockly.blockRendering.Drawer.prototype.draw in drawer.js -> transform is set by this.drawInternals_() and next Blockly.blockRendering.Drawer.prototype.layoutField_
// Blockly.blockRendering.Drawer.prototype.drawInternals_ in drawer.js
// Blockly.blockRendering.Drawer.prototype.layoutField_ in drawer.js


// But we need to find a solution how to transfer the offset values that goes into Blockly.Input.prototype.appendField in input.js
// Our inputList>fieldRow has the offset values
// fieldInfo of Blockly.blockRendering.Drawer.prototype.layoutField_ = function(fieldInfo) has [field object]!
...
Blockly.Field.prototype.createBorderRect_ = function() {
  this.borderRect_ = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.RECT, {
        ...
        'x': 0,
        //'y': 0, // ORG
        'y': -1, // CASS_2021 // CASS_FIELD_HEIGHT
...
Blockly.Field.prototype.updateEditable = function() {
  ...
  if (this.sourceBlock_.isEditable()) {
    ...
    group.style.cursor = this.CURSOR;
      ...
      //    if (this.sourceBlock_.type.search("polyade_execute_code_1") != -1) {
      //        group.style.cursor = this.CURSOR;
      //    }
      //}
 ...
 * @package
 */
Blockly.Field.prototype.setVisible = function(visible) { // CASS -> Blockly.blockRendering.Renderer.prototype.render in renderer.js -> core/renderers/common/info.js -> computeBounds_ for width // -> Blockly.blockRendering.InputRow.prototype.measure in core\renderers\measurables\rows.js
  ...
  if (root) {
    ...
    // CASS_BLOCKLY_MODIFIED // ADDED
    // https://github.com/google/blockly/issues/2381
    if (!this.visible_) {
        this.size_.width = 0;
        //this.size_.height = 0;
        //return;
 ...
 * @protected
 */
Blockly.Field.prototype.render_ = function() { // CASS_CHECK ->  getSize() in row_elements.js
  ...
  //this.updateSize_();
    ...
    if (this.textContent_) { // when it's null it doesn't call updateSize_ and make alignment weird
        this.textContent_.nodeValue = this.getDisplayText_();
        //this.updateSize_(); // CASS // ADDED
    }
    this.updateSize_(); // ORG // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    // COMMENTED
    //if (this.visible_) { // ADDED // CASS_BLOCKLY_MODIFIED
    //  this.updateSize_();
    //}
    ////////////////////////////////////////////////////////////////////////////////////////////////////
};
...
Blockly.Field.prototype.showEditor = function(opt_e) {
  if (this.isClickable()) {
    this.showEditor_(opt_e); // CASS_2021 // CHECK // -> Blockly.FieldTextInput.prototype.showEditor_ in field_textinput.js
  }
};
...
Blockly.Field.prototype.updateSize_ = function(opt_margin) {
  ...
  this.positionTextElement_(xOffset, contentWidth); // CASS_2021!!
...
Blockly.Field.prototype.positionTextElement_ = function(xOffset, contentWidth) {
  ...
  // CASS
  //if (this.x_offset == undefined || this.x_offset == null) this.x_offset = 0;
  //if (this.y_offset == undefined || this.y_offset == null) this.y_offset = 0;

  // ORG
  this.textElement_.setAttribute('x', this.sourceBlock_.RTL ?
      this.size_.width - contentWidth - xOffset : xOffset);

  // CASS__2021!! // -> implemented in Blockly.blockRendering.Drawer.prototype.layoutField_
  //this.textElement_.setAttribute('x', this.sourceBlock_.RTL ?
  //    this.size_.width - contentWidth - xOffset : xOffset + this.x_offset); // <- insertFieldAt in input.js
  ...
  // CASS__2021!! // -> implemented in Blockly.blockRendering.Drawer.prototype.layoutField_
  //this.textElement_.setAttribute('y', constants.FIELD_TEXT_BASELINE_CENTER ?
  //    halfHeight - 1.2 + this.y_offset: halfHeight - constants.FIELD_TEXT_HEIGHT / 2 +
  //    constants.FIELD_TEXT_BASELINE);
  // CASS_FIELD_HEIGHT // CASS_TEXT_Y_POSITION!!!
  this.textElement_.setAttribute('y', constants.FIELD_TEXT_BASELINE_CENTER ?
      halfHeight - 1 : halfHeight - constants.FIELD_TEXT_HEIGHT / 2 +
      constants.FIELD_TEXT_BASELINE); // Y POSITION

  //console.error(this.sourceBlock_);
};
 ...
 */
Blockly.Field.prototype.getSize = function() { // CASS_CHECK ->  getSize() in row_elements.js
  if (!this.isVisible()) {
