...
Blockly.FieldImage.prototype.initView = function() {
  this.imageElement_ = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.IMAGE,
      {
        ...
        'alt': this.altText_
        //'transform': 'translate(' + this.x_offset + ',' + this.y_offset + ')', // CASS_2021! // ADDED // This is it!! // -> implemented in Blockly.blockRendering.Drawer.prototype.layoutField_
      },
      this.fieldGroup_);
  ...
  //this.fieldGroup_.style.transform = 'translate(' + this.x_offset + ',' + this.y_offset + ')'; // CASS // Tried // X
};
