...
Blockly.VerticalFlyout.prototype.setMetrics_ = function(xyRatio) {
  ...
  if (typeof xyRatio.y == 'number') {
    this.workspace_.scrollY =
        -(scrollMetrics.top +
            (scrollMetrics.height - viewMetrics.height) * xyRatio.y); /*console.error(this.workspace_.scrollY, metrics.absoluteTop);*/ // CASS
  }
...
Blockly.VerticalFlyout.prototype.position = function() {
  ...
  this.height_ = targetWorkspaceViewMetrics.height; // - 100 // CASS_CHECK
  ...
  var x = this.getX();
  var y = this.getY(); // + 100 // CASS_CHECK

  this.positionAt_(this.width_, this.height_, x, y); // CASS // this.width_: The computed width of the flyout's SVG group // <- width set in Blockly.VerticalFlyout.prototype.reflowInternal_
};
...
// CASS
// in workspace_svg.js for workspace scroll
//if (!this.isFlyout) {
...
// -> Blockly.svgResize in blockly.js // -> mainWorkspace.resize();
// -> Blockly.WorkspaceSvg.prototype.resize in workspace_svg.js
// -> Blockly.Toolbox.prototype.position in toolbox.js
// -> Blockly.VerticalFlyout.prototype.position in flyout_vertical.js // CASS_CHECK!
// -> Blockly.Flyout.prototype.positionAt_ in flyout_base.js
// -> Blockly.Scrollbar.prototype.resize in scrollbar.js

// !!
// Blockly.bindEventWithChecks_ -> func.call(thisObject, event); // e(event) = PointerEvent
// Blockly.Scrollbar.prototype.onMouseMoveHandle_ in scrollbar.js // -> this.onScroll_(); //////////////////////////////////

// !!
// Blockly.bindEventWithChecks_ = function(node, name, thisObject, func, opt_noCaptureIdentifier, opt_noPreventDefault) in blockly.js
// Blockly.bindEventWithChecks_(this.svgGroup_, 'wheel', this, this.wheel_) in flyout_base.js
// Blockly.Flyout.prototype.wheel_; in flyout_base.js
// -> Blockly.bindEventWithChecks in blockly.js // e(event) = WheelEvent // -> func.call(thisObject, event);
// -> Blockly.VerticalFlyout.prototype.wheel_ in here flyout_vertical.js // -> this.scrollbar.set(pos);
// -> Blockly.Scrollbar.prototype.set in scrollbar.js // -> this.onScroll_(); //////////////////////////////////
// -> Blockly.Scrollbar.prototype.onScroll_ in scrollbar.js // -> this.workspace_.setMetrics(xyRatio);
// -> Blockly.VerticalFlyout.prototype.setMetrics_ in here flyout_vertical.js // -> this.workspace_.translate
// -> Blockly.WorkspaceSvg.prototype.translate in workspace_svg.js // -> this.maybeFireViewportChangeEvent();
// -> Blockly.WorkspaceSvg.prototype.maybeFireViewportChangeEvent in workspace_svg.js // -> Blockly.Events.fire(event);
// -> Blockly.Events.fire in events.js

// -> Blockly.Events.fireNow_ in events.js
// -> Blockly.Workspace.prototype.fireChangeListener in workspace.js
// -> Blockly.Flyout.prototype.reflow in flyout_base.js
// 
...
Blockly.VerticalFlyout.prototype.wheel_ = function(e) {
  ...
  if (scrollDelta.y) {
    ...
    this.workspace_.scrollbar.setY(pos); /*console.error(pos);*/ // CASS
 ...
 * @protected
 */
Blockly.VerticalFlyout.prototype.layout_ = function(contents, gaps) { // CASS_CHECK // <- Blockly.Flyout.prototype.createFlyoutInfo_ in flyout_base.js
  ...
  for (var i = 0, item; (item = contents[i]); i++) {
    if (item.type == 'block') {
      ...
      //blockHW.width = blockHW.width + 111; // CASS_ADDED // COMMENTED
      var moveX = block.outputConnection ? cursorX - this.tabWidth_ : cursorX;
      block.moveBy(moveX, cursorY);

      var rect = this.createRect_(block,
          this.RTL ? moveX - blockHW.width : moveX, cursorY, blockHW, i); // CASS_CHECK // -> Blockly.Flyout.prototype.createRect_ in flyout_base.js
...
Blockly.VerticalFlyout.prototype.reflowInternal_ = function() {
  ...
  for (var i = 0, button; (button = this.buttons_[i]); i++) {
    flyoutWidth = Math.max(flyoutWidth, button.width); // CASS_2021 // <- Blockly.FlyoutButton.prototype.createDom in flyout_button // <- this.width = _xSum + _xLeftMargin * 2 + 2;
  }
  ...
  if (this.width_ != flyoutWidth) {
    ...
    this.width_ = flyoutWidth; // ORG
    //this.width_ = flyoutWidth + 11; // CASS_2021!!
    this.position();
  }
};
