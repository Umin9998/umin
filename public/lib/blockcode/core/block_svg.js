...
Blockly.BlockSvg.prototype.updateCollapsed_ = function() {
  ...
  var text = this.toString(Blockly.COLLAPSE_CHARS); // CASS // CHECK_2021
 ...
 * @package
 */
//Blockly.BlockSvg.prototype.toCopyData = function() { // ORG
Blockly.BlockSvg.prototype.toCopyData = function(withLinked) { // CASS // -> blockly.js
  if (this.isInsertionMarker_) {
    return null;
  }
  var xml = /** @type {!Element} */ (Blockly.Xml.blockToDom(this, true));
  // Copy only the selected block and internal blocks.
  //Blockly.Xml.deleteNext(xml); // ORG

    if (withLinked !== true) { // ADDED // CASS_BLOCKLY_MODIFIED
...
Blockly.BlockSvg.prototype.render = function(opt_bubble) {
  ...
  try {
    ...
    this.workspace.getRenderer().render(this); // -> Blockly.blockRendering.Renderer.prototype.render in renderer.js // CASS_2021!
