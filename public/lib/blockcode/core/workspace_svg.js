...
Blockly.WorkspaceSvg = function(
  ...
  */
  ...
  if (Blockly.Procedures && Blockly.Procedures.flyoutCategory) {
    this.registerToolboxCategoryCallback(Blockly.PROCEDURE_CATEGORY_NAME, // CASS_BREAK
...
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function(xmlBlock) {
  ...
  try {
    var block = Blockly.Xml.domToBlock(xmlBlock, this);
      ...
      var blockX;
      var blockY;
      if (this.mouseEventLast != undefined && this.mouseEventLast != null) {

          // https://groups.google.com/g/blockly/c/oc2XYXJa9vw
          // Save off the mouse coordinates for other people to use
          var point = Blockly.utils.mouseToSvg(this.mouseEventLast, this.getParentSvg(), this.getInverseScreenCTM());
          //console.error(point);
          var rel = this.getOriginOffsetInPixels();
          blockX = (point.x - rel.x) / this.scale;
          blockY = (point.y - rel.y) / this.scale;
          ...
          blockX = parseInt(xmlBlock.getAttribute('x'), 10); // CASS_COMMENTED
          blockY = parseInt(xmlBlock.getAttribute('y'), 10); // CASS_COMMENTED
      }
      //////////////////////////////////////////////////////////////////////////////////////////////////////

    // Move the duplicate to original position.
    //var blockX = parseInt(xmlBlock.getAttribute('x'), 10); // CASS_COMMENTED
    //var blockY = parseInt(xmlBlock.getAttribute('y'), 10); // CASS_COMMENTED
...
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function(e) {
  ...
  if (gesture) {
    ...
    this.mouseEventLast = e; // CASS_ADDED
    //console.error(e); // CASS_ADDED
};
